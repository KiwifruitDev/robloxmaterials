...
gamma_correction = 2.2 # (120 / 240) ^ 2.2 = 0.218
...
materials = [
    ...
    ["concrete", "concrete"],
    ["corrodedmetal", "metalpanel"],
    ["crackedlava", "gravel"],
    ["diamondplate", "metalgrate"],
    ["fabric", "carpet"],
    ["glacier", "ice"],
    ["glass", "combine_glass"],
    ["granite", "concrete"],
...
surfacetypes = [
    ...
    ["hinge", "concrete"],
    ["motor", "concrete"],
    ["smoothnooutlines", "concrete"],
]

textureless_surfacetypes = [
    "smooth",
    "glue",
    "hinge",
    "motor",
